...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", 
    default='django-insecure-qt*l1g89%#u&eap+wk-61w_6^_*6i++o9%o77o=h%0q6@0k0$l'
)
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS':
        'rest_framework.pagination.LimitOffsetPagination', 'PAGE_SIZE': 15,
}
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://postagram-redis-1:6379",
        "OPTIONS": {
